...
public class AgentRegisterRequest {
    ...
    @NotBlank
    @Schema(description = "에이전트 이름 (설명용, 중복 허용)", example = "summary-agent")
    private String name;
    ...
    public AgentRegisterServiceRequest toServiceRequest() {
        return AgentRegisterServiceRequest.builder()
                .name(name)
                .type(type)
                .protocol(protocol)
                .endpoint(endpoint)
